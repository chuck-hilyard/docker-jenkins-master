...
RUN apt-get -y update && apt-get -y upgrade && apt-get -y install python3 python3-pip python3-boto3 vim sudo python3-jenkins
...
RUN chmod 640 /var/jenkins_home/.ssh/id_rsa
